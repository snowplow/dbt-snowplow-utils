...
select
  *
  ...
  contexts_com_snowplowanalytics_snowplow_ua_parser_context_1_0_0, contexts_nl_basjes_yauaa_context_1_0_0,
  contexts_com_snowplowanalytics_user_identifier_1_0_0, contexts_com_snowplowanalytics_user_identifier_2_0_0,
  ...
  JSON_EXTRACT_ARRAY(contexts_com_snowplowanalytics_user_identifier_1_0_0) as contexts_com_snowplowanalytics_user_identifier_1_0_0,
  JSON_EXTRACT_ARRAY(contexts_com_snowplowanalytics_user_identifier_2_0_0) as contexts_com_snowplowanalytics_user_identifier_2_0_0,
  JSON_EXTRACT_ARRAY(contexts_com_snowplowanalytics_session_identifier_1_0_0) as contexts_com_snowplowanalytics_session_identifier_1_0_0,
  JSON_EXTRACT_ARRAY(contexts_com_snowplowanalytics_session_identifier_2_0_0) as contexts_com_snowplowanalytics_session_identifier_2_0_0,
  JSON_EXTRACT_ARRAY(contexts_com_snowplowanalytics_custom_entity_1_0_0) as contexts_com_snowplowanalytics_custom_entity_1_0_0,
  ...
  array(
    ...
    array(
      select as struct
        ...
        from unnest(contexts_com_snowplowanalytics_session_identifier_1_0_0) as json_array
    ) as contexts_com_snowplowanalytics_session_identifier_1_0_0,
    array(
      select as struct
        JSON_EXTRACT_scalar(json_array,'$.session_identifier') as session_identifier
        from unnest(contexts_com_snowplowanalytics_session_identifier_2_0_0) as json_array
