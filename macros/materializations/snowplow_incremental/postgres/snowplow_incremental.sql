...
{% materialization snowplow_incremental, adapter='postgres' -%}
  ...
  {% else %}
      ...
      {% set build_sql = snowplow_utils.snowplow_incremental_upsert_postgres(tmp_relation,
                                                     target_relation,
...
{% macro snowplow_incremental_upsert_postgres(tmp_relation, target_relation, unique_key=none, upsert_date_key=none, disable_upsert_lookback=none, statement_name="main") %}
