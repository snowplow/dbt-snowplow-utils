...
{% macro snowplow_incremental_post_hook_t(package_name='snowplow', incremental_manifest_table_name=none, base_events_this_run_table_name=none) %}
  ...
  {{ snowplow_utils.update_incremental_manifest_table_t(incremental_manifest_table, base_events_this_run_table, successful_snowplow_models) }}
